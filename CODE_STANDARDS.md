...
- **Read-heavy football APIs:** expose only GET routes; split football domains into separate features (`home-feed`, `matches`, `teams`, `players`, `leagues`, `standings`, `search`)
